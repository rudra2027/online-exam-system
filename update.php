...
if(@$_GET['fdid'] && $_SESSION['key']=='rudra2027') {
$id=@$_GET['fdid'];
...
//delete course
if(isset($_SESSION['key'])){
  if(@$_GET['fcourse'] && $_SESSION['key']=='rudra2027') {
  $name=@$_GET['fcourse'];
  $result = mysqli_query($con,"DELETE FROM addcourse WHERE name='$name' ") or die('Error');
  header("location:dash.php?q=6");
  }
  }
//delete user
if(isset($_SESSION['key'])){
if(@$_GET['demail'] && $_SESSION['key']=='rudra2027') {
$demail=@$_GET['demail'];
...
//remove quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='rudra2027') {
$eid=@$_GET['eid'];
...
//add quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='rudra2027') {
$name = $_POST['name'];
...
//add course
if(isset($_SESSION['key'])){
  if(@$_GET['q']== 'addcourse' && $_SESSION['key']=='rudra2027') {
  $name = $_POST['name'];
  $q3=mysqli_query($con,"INSERT INTO addcourse VALUES  ('$name' , NOW())");
...
//add question
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='rudra2027') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
