...
<div class="row">
<div class="col-lg-6">
<span class="logo">Welcome To the Portal</span></div>
<?php
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==6) echo'class="active"'; ?>><a href="dash.php?q=6">Add/remove Course</a></li>
...
<form style ="background-image:/image/bg2;color:black;font-size:60px;text-align:center" action="addcourse.php"" method="POST">
Enter the Course: <input type="text" name="addcourse"  required maxheight="80" maxwidth="80" style="font-color:black">
<br>
<input type="submit" value="Add" name="insert" ><br><br>';
echo '<div style="text-align:center">Available Courses:</div>'; 

  }
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];{
  echo '<br>&nbsp<tr><td>'.$c++.'</td>&nbsp';
 
  echo '<span style="text-align:center"><td><a title="Click to open courses" href="dash.php?q=4">'.$name.'<b><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></b></a></td></span>&nbsp&nbsp&nbsp';

	echo '<td><a title="Delete Course" href="update.php?fcourse='.$name.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td>
