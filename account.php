...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Bingo</b></a>
    </div>
    ...
    <li <?php if(@$_GET['q']==6) echo'class="active"'; ?>><a href="account.php?q=6"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Courses</a></li>
...
if(@$_GET['q']== 6) 
{
$q=mysqli_query($con,"SELECT * FROM addcourse  ORDER BY `name`" )or die('Error223');
echo  '<div class="panel title"><div class="table-responsive">
<table class="table table-striped title1" >
<tr style="color:red"><td><b>Name</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$t=$row['name'];
$c++;
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td><a href="account.php?q=1">'.$t.'</a></td><td>';
}
echo '</table></div></div>';}
?>
